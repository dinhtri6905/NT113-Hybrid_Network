...
interface Ethernet0/3
 ...
 no shutdown
!
! ===== UPLINK TRUNK → SWL3_1 (Cross-Backup) =====
interface Ethernet0/2
 ...
 no shutdown
!
! ===== DOWNLINK – TÒA A ACCESS SWITCHES (backup path) =====
interface Ethernet1/0
 description TO_A-G-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet1/1
 description TO_A-1-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet1/2
 description TO_A-2-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet1/3
 description TO_A-3-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet2/0
 description TO_A-4-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet2/1
 description TO_A-5-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet2/2
 description TO_A-6-SW-01_ACCESS_BACKUP
 switchport mode trunk
...
interface Ethernet2/3
 description TO_A-7-SW-01_ACCESS_BACKUP
 switchport mode trunk
 switchport trunk allowed vlan 76,77,78,79
 spanning-tree portfast trunk
 no shutdown
!
! ===== DOWNLINK – TÒA E ACCESS SWITCHES (primary path) =====
interface Ethernet3/0
 description TO_E-G-SW-01_ACCESS_PRIMARY
 switchport mode trunk
...
interface Ethernet3/1
 description TO_E-1-SW-01_ACCESS_PRIMARY
 switchport mode trunk
...
interface Ethernet3/2
 description TO_E-2-SW-01_ACCESS_PRIMARY
 switchport mode trunk
...
interface Ethernet3/3
 description TO_E-3-SW-01_ACCESS_PRIMARY
 switchport mode trunk
 switchport trunk allowed vlan 112,113,115,116,999
 spanning-tree portfast trunk
 no shutdown
!
! ===== SVI – Distribution (IP .251/mask) =====
interface Vlan10
...
interface Vlan70
 ...
 ip address 10.1.60.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan78
...
interface Vlan82
 ...
 ip address 10.8.40.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan92
 description E-1-FINANCE-STAFF
 ip address 10.9.40.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan102
 description E-2-HR-STAFF
 ip address 10.10.40.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan112
 description E-3-IT-STAFF
 ip address 10.11.40.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan113
 description E-3-SERVER-FARM
 ip address 10.11.50.251 255.255.255.0
 ip ospf 1 area 0
 no shutdown
!
interface Vlan999
...
!
! ===== SPANNING TREE =====
! SWL3_4 là STP backup cho Tòa A
! SWL3_4 là STP root cho Tòa E
